 ...
 */
function navigation($username, $active_page = 'dashboard')
{
    ?>
    <aside id="left-panel">
        ...
        -->
            ...
            <ul>
                <li <?php echo($active_page == 'dashboard' ? 'class="active"' : 'class=""'); ?>>
                    <a href="user" title="Dashboard"><i class="fa fa-lg fa-fw fa-home"></i> <span
                            class="menu-item-parent">Dashboard</span></a>
                </li>
                <li <?php echo($active_page == 'article' ? 'class="active"' : 'class=""'); ?>>
                    <a href="article" title="Articles"><i class="fa fa-lg fa-fw fa-home"></i> <span
                            class="menu-item-parent">Articles</span></a>
                </li>
                <!--            <li>
